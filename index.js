...
// The internal variable is function scoped, so it is only accessible from inside the function, when the function is called it looks inside itself for a variable to match first before moving to global scope.
